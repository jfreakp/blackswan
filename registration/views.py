...
class RegistroView(CreateView):
    ...
    def get_form(self, form_class = None):
        ...
        form.fields['username'].widget = forms.TextInput(
            attrs={'class':'form-control mb-2', 'placeholder':'Nombre de usuario', 'autocomplete':'nope',})
        form.fields['email'].widget = forms.EmailInput(
            attrs={'class':'form-control mb-2', 'placeholder':'Dirección email', 'autocomplete':'off',})
        form.fields['password1'].widget = forms.PasswordInput(
            attrs={'class':'form-control mb-2', 'placeholder':'Contraseña', 'autocomplete':'off',})
